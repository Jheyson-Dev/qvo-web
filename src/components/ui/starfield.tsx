...
export function StarfieldBackground({
  ...
  const isDark =
    theme === "system" && typeof window !== "undefined"
      ...
      : theme === "dark" || theme === "system"; // Fallback to dark if system fails on SSR
  ...
  }, [count, speed, starColor, twinkle, bgColor, trailColor]);
      ...
      <div
        ...
        style={{
          background: isDark
            ...
            : "radial-gradient(ellipse at center, transparent 0%, transparent 40%, rgba(248,250,252,0.9) 100%)",
        }}
      />
